    ...
    <div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/media/white-gift-box-with-an-empty-and-unlabeled-bottle-2025-02-09-01-12-05-utc.webp"
              alt="Product ready for labeling"
              fill
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/media/labeled-waste-containers-on-blue-2025-03-08-14-25-45-utc.jpg"
              alt="Sustainable labeled containers"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 50vw"
            />
        ...
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <div className="bg-gray-50 rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Label Type</label>
                  <select
                    name="label_type"
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  >
                    <option>Pressure-Sensitive Roll Label</option>
                    <option>Shrink Sleeve</option>
                    <option>Wrap-Around</option>
                    <option>Die-Cut Sticker</option>
                    <option>Barcode / Serialization</option>
                    <option>Tamper-Evident / Security</option>
                    <option>RFID / NFC Smart Label</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  placeholder="Label dimensions, substrate preference, adhesive type, finishing (foil/emboss/varnish), compliance requirements (FDA / EU 1169 / UDI / GHS), quantity, destination market..."
              ...
              <p className="text-xs text-gray-500 text-center">
                We'll respond within 1 business day with sample options and pricing.
              </p>
            </form>
          </div>
        </div>
