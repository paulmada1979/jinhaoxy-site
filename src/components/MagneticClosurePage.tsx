  ...
  return (
    <div>
      ...
      <section className="relative min-h-[620px] flex items-center bg-gray-900 overflow-hidden">
        <Image
          src="/media/black-box-isolated-on-a-white-background-2025-02-02-20-00-39-utc-1.webp"
          alt=""
          fill
          priority
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <ContactForm
            pageContext="Magnetic Closure Gift Boxes"
            companyLabel="Brand"
            select={{
              label: "Box Style",
              options: [...styles.map((s) => s.title), "Not sure — need design advice"],
            }}
            messageLabel="Project details *"
            messagePlaceholder="Product dimensions, weight, volume, insert type (foam / cardboard / velvet), closure feel preference (strong snap / medium / soft close / collapsible flat-pack), finishing, brand guidelines, launch timeline..."
          />
        </div>
      </section>
    </div>
