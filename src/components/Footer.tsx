...
function FacebookIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px]">
      <path d="M24 12.073c0-6.627-5.373-12-12-12S0 5.446 0 12.073C0 18.062 4.388 23.027 10.125 23.927V15.54H7.078v-3.47h3.047V9.428c0-3.007 1.792-4.668 4.533-4.668 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.387C19.612 23.027 24 18.062 24 12.073z" />
    </svg>
  );
}
  ...
  return (
    <footer className="bg-white border-t border-gray-200 mt-24">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-14">
        {/* Top section: logo + contact blocks */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr_1fr_1.3fr] gap-8 pb-10 border-b border-gray-200">
          {/* Logo + tagline */}
          <div>
            <Image
              src="/logo.webp"
          ...
          <div className="flex gap-3">
            <div className="w-10 h-10 rounded border border-gray-300 flex items-center justify-center shrink-0 text-gray-700">
              <Phone size={16} />
            </div>
            <div className="text-sm">
              ...
              <p className="text-gray-600 text-xs leading-relaxed">
                ...
                China<br />
                <a href="tel:+8615817611067" className="hover:text-orange-600">+86-15817611067</a>
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10">
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {productLinks.map((l) => (
                <li key={l.href}>
                  <Link href={`${prefix}${l.href}`} className="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors group">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {companyLinks.map((l) => (
                <li key={l.href}>
                  <Link href={`${prefix}${l.href}`} className="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors">
                    <span className="w-3 h-3 rounded-full border-2 border-orange-500 flex items-center justify-center shrink-0">
                      <span className="w-1 h-1 rounded-full bg-orange-500" />
                    </span>
                    {l.label}
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <a href="#" aria-label="YouTube" className="w-10 h-10 rounded bg-[#ff0000] hover:opacity-90 text-white flex items-center justify-center transition-opacity">
                <YoutubeIcon />
              </a>
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded bg-[#0a66c2] hover:opacity-90 text-white flex items-center justify-center transition-opacity">
                <LinkedinIcon />
              </a>
              <a href="#" aria-label="Instagram" className="w-10 h-10 rounded bg-gray-900 hover:opacity-90 text-white flex items-center justify-center transition-opacity">
                <InstagramIcon />
              </a>
            </div>
          </div>
