    ...
    <div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/media/blue-gift-box-2024-11-25-20-39-22-utc.webp"
              alt="Custom printed gift box"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 50vw"
            />
        ...
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <div className="bg-gray-50 rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100">
            <form className="space-y-4" action="mailto:info@jinhaoxy.com" method="post" encType="text/plain">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Artwork status</label>
                <select name="artwork" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                  <option>Print-ready artwork supplied</option>
                  <option>Rough artwork — needs prepress cleanup</option>
                  <option>Brand guidelines only — need design support</option>
                  <option>Starting from scratch — full creative needed</option>
                </select>
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Project details *</label>
                <textarea name="message" rows={5} required placeholder="Box dimensions, volume, desired finishings (hot foil, emboss, holographic...), Pantone colors, launch timeline..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none" />
              </div>
