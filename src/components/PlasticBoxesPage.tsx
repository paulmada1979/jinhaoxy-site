    ...
    <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <ContactForm
            pageContext="Plastic Crates & Containers"
            select={{
              ...
              options: [
                ...
                "Divider / Compartment Box",
                "Food-Grade Crate",
                "ESD-Safe Electronics Box",
                "Agricultural / Bulk Bin",
                "Not sure — need advice",
              ],
            }}
            messageLabel="Specifications *"
            messagePlaceholder="Dimensions, load weight, color requirements, custom features (lids / dividers / drainage), branding (logo / IML), application (warehouse / food / retail / electronics / agricultural / automotive), quantity, destination market..."
          />
        </div>
      </section>
    </div>
