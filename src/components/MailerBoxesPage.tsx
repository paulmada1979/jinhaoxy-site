  ...
  return (
    <div>
      ...
      <section className="relative min-h-[560px] flex items-center bg-gray-900 overflow-hidden">
        <Image
          src="/media/cardboard-carton-box-with-photos-close-up-2024-09-16-08-33-48-utc.webp"
          alt=""
          fill
          priority
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/media/stacked-brown-cardboard-boxes-in-various-sizes-arr-2025-02-24-20-34-47-utc.webp"
              alt="Stacked brown cardboard mailer boxes"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 50vw"
            />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <ContactForm
            pageContext="E-Commerce Mailer Boxes"
            companyLabel="Brand / Company"
            volume={{ label: "Est. Monthly Volume", placeholder: "e.g. 20,000 boxes/month" }}
            select={{
              label: "Mailer Style",
              options: [...types.map((tp) => tp.title), "Not sure — need advice"],
            }}
            messagePlaceholder="Product, dimensions, print requirements, launch timeline, sustainability preferences..."
          />
        </div>
      </section>
    </div>
