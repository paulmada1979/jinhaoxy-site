    ...
    <div>
      ...
      <section className="relative min-h-[560px] flex items-center bg-gray-900 overflow-hidden">
        <HeroBackgroundVideo
          ...
          fallbackImage="/media/packing-line-in-a-logistics-warehouse-conveyor-b-2025-01-09-01-24-07-utc.webp"
        />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/media/paper-tube-cores-tissues-in-industry-plant-facto-2024-10-18-10-01-13-utc.jpg"
              alt="Paper tube cores and tissues in factory"
              fill
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <ContactForm
            pageContext="Cardboard Trays & Inserts"
            select={{
              label: "Industry",
              options: [
                "Electronics & Devices",
            ...
            messageLabel="Product dimensions & fit requirements *"
            messagePlaceholder="Product dimensions (L×W×H), weight, quantity per tray, board grade, print requirements..."
          />
        </div>
      </section>
    </div>
