    ...
    <div>
      ...
      <section className="relative min-h-[620px] flex items-center bg-gray-900 overflow-hidden">
        <HeroBackgroundVideo
          ...
          fallbackImage="/media/white-box-isolated-on-background-mockup-2024-12-20-11-19-20-utc.webp"
          imageOpacity={0.55}
        />
          ...
          <div className="bg-gray-50 rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100">
            <form className="space-y-4" action="mailto:info@jinhaoxy.com" method="post" encType="text/plain">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Marketplace</label>
                  <select name="marketplace" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Est. Annual Volume</label>
                <input type="text" name="volume" placeholder="e.g. 100,000 boxes/year" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Project details *</label>
                <textarea name="message" rows={5} required placeholder="Product, box dimensions, closure preference (magnetic / ribbon), destination markets, launch timeline..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none" />
              </div>
