  ...
  return (
    <div>
      ...
      <section className="relative min-h-[640px] flex items-center bg-gray-900 overflow-hidden">
        <Image
          src="/media/top-view-of-blue-ribbon-on-man-perfume-in-a-gift-b-2025-02-10-11-30-09-utc.webp"
          alt=""
          fill
          priority
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 lg:px-6">
          ...
          <ContactForm
            pageContext="Cosmetic Gift Boxes"
            ...
            select={{
              ...
              options: [
                ...
                "Not sure — need design advice",
              ],
            }}
            messageLabel="Project details *"
            messagePlaceholder="Bottle/jar dimensions, number of SKUs per set, finishing preferences (hot-foil, emboss, soft-touch), launch timeline, target annual volume, destination port..."
          />
        </div>
      </section>
    </div>
