            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option>Multi-Language Leaflet</option>
                    <option>Assembly Booklet</option>
                    <option>Pharma / Medical IFU</option>
                    <option>Retail Box Insert</option>
                    <option>E-commerce Unboxing Insert</option>
                    <option>Other</option>
                  </select>
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Binding</label>
                  <select
                    name="binding"
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  >
                    ...
                    <option>Spiral / Wire-O</option>
                    <option>Folded Leaflet (no binding)</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  placeholder="Page count, number of languages, paper weight (gsm), finishing (lamination / spot UV), quantity, destination market (EU / US / UK / global), compliance requirements (CE / FDA / MDR), launch timeline..."
              ...
              <p className="text-xs text-gray-500 text-center">
                We'll respond within 1 business day with a compliance-ready proposal.
              </p>
            </form>
          </div>
        </div>
