            ...
            <form className="space-y-4" action="mailto:info@jinhaoxy.com" method="post" encType="text/plain">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select name="industry" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                    <option>Cosmetics & Fragrance</option>
                    <option>Jewelry & Watches</option>
                    <option>Electronics Presentation</option>
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Preferred Box Style</label>
              ...
              <div>
                ...
                <textarea name="message" rows={5} required placeholder="Product dimensions, target volume, preferred finishings (hot foil, emboss, soft-touch...), brand guidelines, launch timeline..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none" />
              </div>
